...
namespace IndigoBunting.FrameworkUI
{
    ...
    public class PopupOutSimpleMoving : UITransitionOut
    {
        private CanvasGroup cgBackground;
        private CanvasGroup cgContent;
        
        [Header("Moving values")]
        [SerializeField] private Vector2 initialAnchoredPosition = new Vector2(0f, 0f);
        [SerializeField] private Vector2 endAnchoredPosition = new Vector2(0f, 1200f);
        [SerializeField] private Ease popupEase = Ease.OutBack;
        
        [Header("Fade values")]
        [SerializeField] private float initialBackgroundFade = 0.6f;
        [SerializeField] private float endBackgroundFade = 0.0f;
        ...
        public override void Anim()
        {
            ...
            animInstance.Insert(0.3f, cgContent.DOFade(0.0f, 0.2f).SetEase(Ease.Linear));
